...
### 3.2 Project infrastructure................................................................................................
```
Group5-Drone-Network/
│
│
├── allocation/ (channel assignment and central controller)
│ ├── __init__.py
│ ├── central_controller.py
│ └── channel_assignment.py
│
├── energy/ (energy consumption model)
│ ├── __init__.py
│ └── energy_model.py
│
├── entities/ (core network entities)
│ ├── __init__.py


│ ├── drone.py (drone behavior implementation)
│ └── packet.py (packet types & structure)
│
├── mac/ (Medium Access Control protocols)
│ ├── __init__.py
│ ├── csma_ca.py (CSMA/CA implementation – main MAC)
│
├── mobility/ (UAV motion models)
│ ├── __init__.py
│ ├── gauss_markov_3d.py
│ ├── leader_follower_3d.py
│ ├── random_walk_3d.py
...
├── path_planning/
│ ├── __init__.py
│ ├── path_following_3d.py (path execution controller)
│
├── phy/ (Physical Layer modeling)
│ ├── __init__.py
│ ├── channel.py (default broadcast/unicast channel)
│ ├── channel_create.py (channel factory)
│ ├── large_scale_fading.py (path loss & SINR)
│ ├── phy.py (transmission energy + bitrate)
│ ├── prob_channel.py (probabilistic packet-loss channel)
│ └── tech_profiles.py (802.11b/g/n/AC profiles)
│
├── routing/
│ ├── aodv/ (AODV implementation)
│ │ ├── aodv.py
│ │ ├── aodv_packet.py
│ │ └── aodv_neighbor_table.py
│ │
│ │
│ └── olsr/ (OLSR implementation)
│ ├── olsr.py
│ ├── olsr_packet_
│ ├── olsr_packet.py
│ └── olsr_routing_table.py
...
├── simulator/
│ ├── __init__.py
│ ├── log.py (configurable logging wrapper)
│ ├── metrics.py (packet counts, delays, collisions, PDR)
│ └── simulator.py (core SimPy engine)
│
├── topology/ (network topology generation)
│ ├── virtual_force/ (virtual force)
...
│ ├── util_function.py (helpers: distance, channel sensing, grid)
│ └── ieee_802_11.py (Wi-Fi timing parameters)
│
├── visualization/
│ ├── __init__.py
│ ├── visualizer.py (animation + interactive visualization)
│ └── static_drawing.py (static scatter plots)
│
