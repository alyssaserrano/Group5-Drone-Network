...
wifi_11n = WifiProfile(
    ...
    mesh_support=False,
    energy_model={"TX": 1000, "RX": 800, "Idle": 100, "Sleep": 5},  # mW
...
wifi_11ac = WifiProfile(
    ...
    mesh_support=False,
    energy_model={"TX": 1200, "RX": 900, "Idle": 120, "Sleep": 5},  # mW
...
wifi_direct = WifiProfile(
    ...
    energy_model={"TX": 900, "RX": 700, "Idle": 100, "Sleep": 5},   # mW Accurate to profile
